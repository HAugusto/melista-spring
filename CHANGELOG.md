...
- Estrutura inicial do projeto Spring Boot com Maven.
- Configuração básica da aplicação principal em `Application.java`.
- Controlador inicial `HomeController` com endpoint raiz (`GET /`) retornando uma página HTML simples.
